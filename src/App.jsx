...
const AREAS = [
  ...
  },
  {
    ...
    name: "Operación & IT",
    person: "Mónica Magni",
    role: "Sub Gerente General Operación & IT",
    icon: "⚙",
    color: "#3B82F6",
    questions: [
    ...
    note: "Este Discovery incluye aportes recogidos en distintos momentos del proceso, reflejando una mirada amplia del área."
  },
  {
    id: "comercial",
    name: "Comercial",
    person: "Francisco Ranieri",
    ...
    findings: [
      ...
      "Otros Riesgos representa una oportunidad concreta: 1.500 cotizaciones mensuales gestionadas por email, con potencial de triplicar conversión.",
  ...
  },
  {
    ...
    person: "María Inés Veloce",
    role: "Gerente de Proyectos & Innovación",
    icon: "✦",
    color: "#8B5CF6",
    questions: [
  ...
  },
  {
    ...
    person: "Gonzalo Ferreira",
    role: "Gerente Técnico & de Reaseguros",
    icon: "◇",
    color: "#EF4444",
    questions: [
  ...
  },
  {
    ...
    person: "María Cecilia Bensadón",
    role: "Gerente de Estrategia & Marketing",
    icon: "◉",
    color: "#EC4899",
    questions: [
          ...
          <div style={{ minHeight: "85vh", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <FadeIn delay={1.1}>
              <div style={{ display: "flex", gap: 48, marginTop: 80, paddingTop: 40, borderTop: "1px solid #1A3D2A" }}>
                {[
                  { n: "5", label: "Gerencias escuchadas" },
            ...
            <FadeIn delay={0.2}>
              <div style={{ display: "flex", justifyContent: "center", marginBottom: 8 }}>
                <div className={`org-node ${activeArea === "direccion" ? "selected" : ""}`}
                  ...
                  <div style={{ fontSize: 13, color: AREAS[0].color, marginTop: 4 }}>{AREAS[0].person}</div>
                  <div style={{ fontSize: 11, color: "#5A8B6A", marginTop: 2 }}>{AREAS[0].role}</div>
                </div>
              </div>
            </FadeIn>
              ...
              {AREAS.slice(1).map((a, i) => (
                <FadeIn key={a.id} delay={0.4 + i * 0.1}>
                  ...
                  <div className={`org-node ${activeArea === a.id ? "selected" : ""}`}
                    ...
                    <div style={{ fontSize: 12, color: a.color, marginTop: 6 }}>{a.person}</div>
                    <div style={{ fontSize: 10, color: "#5A8B6A", marginTop: 2, lineHeight: 1.3 }}>{a.role}</div>
                  </div>
                </FadeIn>
              ))}
            </div>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 600, fontFamily: "'Cormorant Garamond', serif" }}>
                      {area.person} · <span style={{ fontWeight: 400, color: "#7A9B8A" }}>{area.role}</span>
                    </div>
                    {area.note && (
                      <div style={{ fontSize: 12, color: "#5A8B6A", marginTop: 8, fontStyle: "italic", maxWidth: 600 }}>
                        {area.note}
                      </div>
                    )}
                  </div>
                  ...
                  {activeTab === "escuchamos" && (
                    <div>
                      <p style={{ fontSize: 13, color: "#5A8B6A", marginBottom: 20 }}>
                        Preguntas reales del proceso de Discovery — formuladas para entender, no para juzgar.
                      </p>
